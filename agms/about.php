            ...
            <div class="about-sub-inner text-center mt-lg-4 mt-3">
               ...
               <div class="row">
                  <div class="col-lg-4 col-md-4 abut-gride">
                     ...
                     <h5>Shipping</h5>
                     <p class="mt-3"> We offer fast and secure shipping to ensure your artwork reaches you in perfect condition, wherever you are.
                     </p>
                  </div>
                  <div class="col-lg-4 col-md-4 abut-gride">
                     <span class="fas fa-phone-volume"></span>  
                     <h5>Support</h5>
                     <p class="mt-3"> Need help? Our support team is here to assist you with any questions or concerns.
                  ...
                  <div class="col-lg-4 col-md-4 abut-gride">
                     ...
                     <h5> Return</h5>
                     <p class="mt-3"> Not satisfied? We provide easy returns within 7 days for a hassle-free experience.
                     </p>
                  </div>
               </div>
            </div>
